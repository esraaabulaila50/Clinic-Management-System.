...
if ($_SESSION['role'] !== 'admin') {
    die("<div dir='rtl' style='color:red; text-align:center; margin-top:50px; font-family:sans-serif;'>
            ...
            <a href='doctors.php' style='display:inline-block; padding:10px 20px; background:#007bff; color:white; text-decoration:none; border-radius:5px;'>العودة لقائمة الأطباء</a>
         </div>");
}
